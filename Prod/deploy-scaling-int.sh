#!/bin/bash
# ============================================================
# WNXT Integration - Deploy Scaling Policy
...
REGION=us-east-1
ASG_NAME=WNXT-INT-USER-ASG
CLUSTER_NAME=WNXT-INT-CLUSTER
...
echo "============================================"
echo "WNXT Integration Scaling Configuration:"
echo "  ASG:                ${ASG_NAME}"
...
aws autoscaling put-scaling-policy \
  ...
  --policy-name "WNXT-INT-USER-TargetTracking-Sessions" \
...
SCALEIN_POLICY_ARN=$(aws autoscaling put-scaling-policy \
  --auto-scaling-group-name ${ASG_NAME} \
  --policy-name "WNXT-INT-USER-StepScaleIn-Sessions" \
...
aws cloudwatch put-metric-alarm \
  --alarm-name "WNXT-INT-Sessions-ScaleIn" \
